# A0131140E
###### ./src/main/antlr4/cs2103/v15_1j/jolt/antlr4/UserCommand.g4
``` g4
grammar UserCommand;
...
WS: [ \t\r\n]+ -> skip;
```
###### ./src/main/java/cs2103/v15_1j/jolt/parser/JoltCommandVisitor.java
``` java
...
```
###### ./src/main/java/cs2103/v15_1j/jolt/parser/JoltParser.java
``` java
package cs2103.v15_1j.jolt.parser;
...
```
###### ./src/test/java/cs2103/v15_1j/jolt/parser/JoltParserAliasTest.java
``` java
package cs2103.v15_1j.jolt.parser;
...
```
###### ./src/test/java/cs2103/v15_1j/jolt/parser/JoltParserCommandTest.java
``` java
package cs2103.v15_1j.jolt.parser;
...
```
###### ./src/test/java/cs2103/v15_1j/jolt/parser/JoltParserDateTimeTest.java
``` java
package cs2103.v15_1j.jolt.parser;
...
```
###### ./src/test/java/cs2103/v15_1j/jolt/parser/JoltParserSearchFilterTest.java
``` java
package cs2103.v15_1j.jolt.parser;
